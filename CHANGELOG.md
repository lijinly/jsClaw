...
#### 性能优化
- **减少重复判断**：Sheepy 和 Worker Agent 不再重复分析任务，节省约 25% 的 LLM 调用
- **降低 Token 消耗**：只传递相关工具给 Worker Agent，节省约 70% 的 token
- **工具智能筛选**：根据任务特点选择最相关的工具，避免无关工具干扰

### 📝 文档更新

- 新增 `SHEEPY.md` - Sheepy 使用文档
- 新增 `REFACTORING.md` - 重构说明文档
- 更新 `README.md` - 添加 Sheepy 相关内容
- 更新 `demo-sheepy.js` - Sheepy 演示示例

### 🔧 代码变更

**Sheepy (`src/sheepy.js`)**
